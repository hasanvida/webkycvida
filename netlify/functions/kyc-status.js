...
// Calls VIDA KYC Status API: GET /api/v2/verify/status?verificationId=UUID
...
exports.handler = async function (event) {
  ...
  try {
    ...
    const res = await fetch(
      `https://qa-api.vida.id/api/v2/verify/status?verificationId=${encodeURIComponent(verificationId)}`,
      {
        method: "GET",
        headers: {
